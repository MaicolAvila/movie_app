...
//   Future<Controllerauth?> registrarEmail() async {
//     final snapshot = await firestore.doc('user/${currentUser.uid}').get();
//     if (snapshot.exists) return Controllerauth.fromFirebaseMap(snapshot.data()!);
//     return null;
//   }

//   Future<void> saveMyUser(Controllerauth user, File? image) async {
